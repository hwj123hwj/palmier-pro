...
[[stitchable]] float4 glowBright(coreimage::sample_t s, float threshold, float warmth) {
...
[[stitchable]] float4 glowComposite(coreimage::sampler img, coreimage::sampler glow, float intensity) {
